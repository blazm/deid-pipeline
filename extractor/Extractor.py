...
'''
# Original code taken from: https://github.com/rcmalli/keras-vggface
...
class Extractor:
    ...
    def __init__(self, include_top=False, weights='vggface', input_tensor=None):
        self.model = VGGFace(include_top, weights,  input_tensor)

    def extract(self, img, roi=None):
        #x, y, w, h = roi # if roi defined
